...
//void printOrdSum(int prodQty[3][20]);
	...
	for (int x = 0; x < 3; x++){
		for(int j = 0; j < 20; ++j) {
			if (prodQty[x][j] != 0){
	    		...
	    		case 0:
	    			cout << fastDrive.stockNum << "\t" << fastDrive.type << "\t" << fastDrive.size << "\t" << fastDrive.speed << "\tPrice: " << fastDrive.price << "\tQty Ordered " << prodQty[x][j] << endl;
			   	break;
		
				case 1:
					cout << fastSSD.stockNum << "\t" << fastSSD.type << "\t" << fastSSD.size << "\t" << fastSSD.speed << "\tPrice: " << fastSSD.price << "\tQty Ordered " << prodQty[x][j] << endl;
		      	break;
		
				case 2:
					cout << avgDrive.stockNum << "\t" << avgDrive.type << "\t" << avgDrive.size << "\t" << avgDrive.speed << "\tPrice: " << avgDrive.price << "\tQty Ordered " << prodQty[x][j] << endl;
				break;	
   			}
			} 
        }
