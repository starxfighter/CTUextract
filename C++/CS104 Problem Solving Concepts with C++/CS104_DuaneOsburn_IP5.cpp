...
//Make use of an array
   ...
   arrayIn[4] = 19;
   for (int x = 0; x < 5; x++){
   	   if (arrayIn[x] != luckNum)
   	      {cout << "The number " << arrayIn[x] << " is not our addition number" << endl;}
	   else
	      {cout << "The number " << arrayIn[x] << " is our addition number. Great Job!" << endl;}		  
   }
