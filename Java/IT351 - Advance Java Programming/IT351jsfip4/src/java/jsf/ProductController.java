 ...
 * Module: Java Server Faces Definition for Product 
 * Created: 09/06/2016
 * Modified:09/06/2016
 * 
 * Purpose: This definition holds the methods used by the Java Server Faces to interact with the product table that is in the IT351Sales database.
