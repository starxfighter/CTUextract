 ...
 * Module: Enterprise Java Bean Definition -- General 
 * Created: 09/06/2016
 * Modified:09/06/2016
 * 
 * Purpose: This EJB handles the general components for the environment. This will be overridden by specific customer or product methods.
