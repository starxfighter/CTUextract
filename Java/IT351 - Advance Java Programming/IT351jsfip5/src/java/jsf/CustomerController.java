 ...
 * Module: Java Server Faces Definition for Customer 
 * Created: 09/06/2016
 * Modified:09/06/2016
 * 
 * Purpose: This definition holds the methods used by the Java Server Faces to interact with the customer table that is in the IT351Sales database.
 * The methods included within are CRUD (Create, Replace, Update, Delete). The JSF uses the corresponding html page in order to make the interaction with the database 
 * easy and uncomplicated for the user.
 * Modification:
 * 
 */
package jsf;
...
public class CustomerController implements Serializable {
    ...
    @EJB
    private ejb.CustomerFacade ejbFacade;
