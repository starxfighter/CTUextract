...
//Writer Component
    public void wtiteValidData2(SalesRep sr)throws IOException{
        //Path newFile = Paths.get("salesrep.txt");
        //Path newFile = Paths.get("test.txt");
        String delim = ",";
        File fwriter = new File("salesrep.txt");
        BufferedWriter writer = new BufferedWriter(new FileWriter(fwriter, true));
        //BufferedWriter writer = Files.newBufferedWriter(newFile, Charset.defaultCharset(), StandardOpenOption.APPEND);
