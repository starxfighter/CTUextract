 ...
 * 04/22/2016 Create evaluate button to read salesRep file and determine the records where the total sales are over 8000
 * 04/28/2016 CReate show button to read the contents of the star.txt file and then display it
 * 
 */
package IT252IP5;
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(offSupIn, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
                                    .addComponent(bookIn)
                                    .addComponent(paperIn))
...
//and then call a helper component to print it to a file        
        if (allDataValid){
            ...
            try{
                h.wtiteValidData2(sr, saleFile, writeOpt);
    ...
    private void evalButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_evalButtonActionPerformed
        ...
        Helper h = new Helper();
        //Read and write valid data to the stars file if it passes the criteria
        try{
            List<SalesRep> sr = h.readSaleFile(saleFile);
            h.computeTotal2(sr);
            validWrite.setVisible(true);
            validWrite.setText("Stars file created successfully");
            validWrite.setForeground(Color.green);
        }catch (IOException e){
            System.out.println("bad read");
            validWrite.setVisible(true);
            validWrite.setText("Error reading the salesRep.txt file");
            validWrite.setForeground(Color.red);
        }//end try catch block
    ...
    private void showButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showButtonActionPerformed
        ...
        //Create instance of helper class
        Helper h = new Helper();
        //Read and write valid data to the text area
        try{
            List<SalesRep> st = h.readSaleFile(starFile);
            for (SalesRep sr: st){
                showTextArea.append(sr.toString());
                showTextArea.append("\n");
            }
